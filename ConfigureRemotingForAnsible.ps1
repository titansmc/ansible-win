...
$fwtest2 = netsh advfirewall firewall show rule name="Allow WinRM HTTPS" profile=domain
...
{
    Write-Verbose "Updating firewall rule to allow WinRM HTTPS for domain profile."
    netsh advfirewall firewall set rule name="Allow WinRM HTTPS" new profile=domain
    Write-Log "Updated firewall rule to allow WinRM HTTPS for domain profile."
}
Else
{
